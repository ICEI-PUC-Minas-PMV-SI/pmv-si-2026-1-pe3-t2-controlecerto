...
|--------------------|------------------------------------|----------------------------------------|
| RF1 | Gerenciamento de Folha Salarial |	Processamento de Inclusão, Alteração e Consulta de Custos de Mão de Obra |
| RF2 |	Gerenciamento de Contratos e Inventário	| Processamento de Inclusão, Alteração, Exclusão e Consulta de Contratos, Serviços e Ativos |
| RF3	| Acompanhamento de Fluxo de Caixa |	Acompanhar as receitas e despesas de forma análitica  |
| ... |	...	| ... |
