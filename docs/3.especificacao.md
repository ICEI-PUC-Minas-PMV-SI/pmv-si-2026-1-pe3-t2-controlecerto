...
|--------------------|------------------------------------|
| RNF1 | O ambiente operacional a ser utilizado deve ser mobile (iOS/Android). |
| RNF2 | RBAC deve ser implementado para garantir a segurança dos dados e a eficiência permitindo que a plataforma seja utilizada por outros integrantes da equipe. |
