(function () {
    ...
    const SVG = {
        dashboard: `<svg class="sidebar__icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true"><path d="M6 2H2.66667C2.29848 2 2 2.29848 2 2.66667V7.33333C2 7.70152 2.29848 8 2.66667 8H6C6.36819 8 6.66667 7.70152 6.66667 7.33333V2.66667C6.66667 2.29848 6.36819 2 6 2Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M13.3333 2H10C9.63181 2 9.33333 2.29848 9.33333 2.66667V4.66667C9.33333 5.03486 9.63181 5.33333 10 5.33333H13.3333C13.7015 5.33333 14 5.03486 14 4.66667V2.66667C14 2.29848 13.7015 2 13.3333 2Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M13.3333 8H10C9.63181 8 9.33333 8.29848 9.33333 8.66667V13.3333C9.33333 13.7015 9.63181 14 10 14H13.3333C13.7015 14 14 13.7015 14 13.3333V8.66667C14 8.29848 13.7015 8 13.3333 8Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M6 10.6667H2.66667C2.29848 10.6667 2 10.9651 2 11.3333V13.3333C2 13.7015 2.29848 14 2.66667 14H6C6.36819 14 6.66667 13.7015 6.66667 13.3333V11.3333C6.66667 10.9651 6.36819 10.6667 6 10.6667Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>`,

        receitas: `<svg class="sidebar__icon" xmlns="http://www.w3.org/2000/svg" width="16" height="17" viewBox="0 0 16 17" fill="none" aria-hidden="true"><path d="M8 12.75H2.66667C2.31305 12.75 1.97391 12.6007 1.72386 12.3351C1.47381 12.0694 1.33333 11.7091 1.33333 11.3333V5.66667C1.33333 5.29094 1.47381 4.93061 1.72386 4.66493C1.97391 4.39926 2.31305 4.25 2.66667 4.25H13.3333C13.687 4.25 14.0261 4.39926 14.2761 4.66493C14.5262 4.93061 14.6667 5.29094 14.6667 5.66667V9.20833M12 8.5H12.0067M12.6667 15.5833V11.3333M10.6667 13.4583L12.6667 11.3333L14.6667 13.4583M4 8.5H4.00667M9.33333 8.5C9.33333 9.2824 8.73638 9.91667 8 9.91667C7.26362 9.91667 6.66667 9.2824 6.66667 8.5C6.66667 7.7176 7.26362 7.08333 8 7.08333C8.73638 7.08333 9.33333 7.7176 9.33333 8.5Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>`,

        despesas: `<svg class="sidebar__icon" xmlns="http://www.w3.org/2000/svg" width="16" height="17" viewBox="0 0 16 17" fill="none" aria-hidden="true"><path d="M8 12.75H2.66667C2.31305 12.75 1.97391 12.6007 1.72386 12.3351C1.47381 12.0694 1.33333 11.7091 1.33333 11.3333V5.66667C1.33333 5.29094 1.47381 4.93061 1.72386 4.66493C1.97391 4.39926 2.31305 4.25 2.66667 4.25H13.3333C13.687 4.25 14.0261 4.39926 14.2761 4.66493C14.5262 4.93061 14.6667 5.29094 14.6667 5.66667V9.20833M14.6667 13.4583L12.6667 15.5833L10.6667 13.4583M12.6667 15.5833V11.3333M12 8.5H12.0067M4 8.5H4.00667M9.33333 8.5C9.33333 9.2824 8.73638 9.91667 8 9.91667C7.26362 9.91667 6.66667 9.2824 6.66667 8.5C6.66667 7.7176 7.26362 7.08333 8 7.08333C8.73638 7.08333 9.33333 7.7176 9.33333 8.5Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
    ...
    const navItems = [
        { href: 'dashboard.html', label: 'Visão Geral', icon: SVG.dashboard },
    ...
    const menuHTML = navItems
        .filter(item => !item.adminOnly || usuarioLogado.cargo === 'Administrador')
        .map(item => {
            const ativo = paginaAtual === item.href;
            return `
                <li>
                    <a href="${item.href}"
                       class="sidebar__link${ativo ? ' sidebar__link--active' : ''}"
    ...
    const html = `
        <aside class="sidebar" aria-label="Menu principal">
            <div class="sidebar__brand">
                <img src="../../assets/imgs/logo.png" alt="ControleCerto" class="sidebar__logo" />
            </div>
            <hr class="sidebar__divider" />
            <nav class="sidebar__nav" aria-label="Navegação do painel">
                <ul class="sidebar__menu">${menuHTML}</ul>
            </nav>
            <footer class="sidebar__footer">
                ...
                <div class="sidebar__user">
                    ...
                    <div class="sidebar__user-info">
                        <span class="sidebar__user-name"    id="sidebar-username">${usuarioLogado.nome || '—'}</span>
                        <span class="sidebar__user-empresa" id="sidebar-empresa">${usuarioLogado.empresa || '—'}</span>
